<%-- 
    Document   : Login
    Created on : Nov 19, 2017, 10:06:28 AM
...
<div class="login-page">
  ...
  <div class="form">
    ...
    <form class="login-form"  action="Login.jsp" method="POST">
      ...
      <script>
        <%  
         UserCtrl ob=new UserCtrl();
         
     if(request.getParameter("submit") != null)
     {
         ArrayList<User> list=ob.getUser(request.getParameter("username"));
              ...
              for (User user : list)
                {
                    if( (user.getPassword().equalsIgnoreCase(request.getParameter("password"))) )
                    {
                        ...
                        if(user.getType().equalsIgnoreCase("Stock"))
                        {
                             
                        }
                         if(user.getType().equalsIgnoreCase("Receptionist"))
                        {
